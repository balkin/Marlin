...
#define STRING_CONFIG_H_AUTHOR "BaRoN" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "UlTi Steel brn"
...
#elif (GITHUB_USER==BALKIN)
 #define DEFAULT_Kp 29.05
 #define DEFAULT_Ki 1.94
 #define DEFAULT_Kd 108.76
#else
  // Ultimaker
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#if (GITHUB_USER==BALKIN)
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 402.8 }
#else
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 4000, 4000, 200, 200 } // ...or, set your own edit limits
#endif
...
#elif (GITHUB_USER==BALKIN) //не тыкаем в ковер, у меня щуп есть
  #define LEVEL_CORNERS_HEIGHT     0.5            // (mm) Z height of nozzle at leveling points
#else
